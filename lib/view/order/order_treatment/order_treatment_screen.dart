...
class OrderTreatmentScreen extends BaseView<OrderTreatmentController> {
  const OrderTreatmentScreen({super.key});

  @override
  OrderTreatmentController createController(BuildContext context)
  => OrderTreatmentController(context);
  ...
  Widget _body() {
    if(controller.screenStateIsLoading) {
        ...
        child: Center(child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Utilities.retryButton(() => controller.onGetListOrderCombo()),
              const SizedBox(height: 10),
            ],
          ),
        )),
      ...
      return BlocBuilder<OrderTreatmentCubit, List<Data>>(
            ...
            return WidgetListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () => Navigator.pushNamed(context, OrderTreatmentDetailScreen.router, arguments: listOrder[index].id),
                  child: Padding(
                                            ...
                                            children: [
                                              ...List.generate(
                                                listOrderDetail.length > 3 ? 3 : listOrderDetail.length,
                                                  ...
                                                  children: [
                                                    Expanded(child: Text(
                                                      listOrderDetail[index].combo?.name ?? "Sản phẩm khác",
