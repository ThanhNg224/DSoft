...
class BillSpendAddScreen extends BaseView<BillSpendAddController> {
  static const String router = "/BillSpendAddScreen";
  const BillSpendAddScreen({super.key});

  @override
  BillSpendAddController createController(BuildContext context)
  => BillSpendAddController(context);

  @override
  Widget zBuild() {
    return BlocBuilder<BillSpendAddCubit, BillSpendAddState>(
          ...
          return Scaffold(
            ...
            bottomNavigationBar: SizedBox(
              ...
              child: Padding(
                ...
                child: WidgetButton(
                  title: "Lưu thông tin phiếu chi",
                  vertical: 0,
                  onTap: ()=> controller.onSaveBill(),
                ),
              ),
            ),
            body: BlocBuilder<BillSpendAddCubit, BillSpendAddState>(
                builder: (context, state) {
  ...
  Widget _boxBookTime(BillSpendAddState state) {
    return Column(
