...
class WidgetCircularWait extends StatefulWidget {
  final Color? color;
  final double? strokeWidth, size;
  const WidgetCircularWait({super.key, this.color, this.strokeWidth, this.size});

  @override
  State<WidgetCircularWait> createState() => _WaitState();
}

class _WaitState extends State<WidgetCircularWait> with SingleTickerProviderStateMixin {
    ...
    return AnimatedBuilder(
      ...
      child: CustomPaint(
        ...
        painter: CircularSegmentPainter(
            color: widget.color ?? MyColor.slateBlue,
