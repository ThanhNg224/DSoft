class ModelListSpendBill {
  List<Data>? data;
  int? code;
  String? messages;
  int? totalData;

  ModelListSpendBill({this.data, this.code, this.messages, this.totalData});

  ModelListSpendBill.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
